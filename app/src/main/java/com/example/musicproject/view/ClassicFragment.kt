...
import com.example.musicproject.databinding.ClassicListBinding
...
class ClassicFragment(private val apiService: ApiService,
                      private val term: String): Fragment() {

    lateinit var binding: ClassicListBinding
    ...
    override fun onCreateView(
        ...
        binding = ClassicListBinding.inflate(layoutInflater)
    ...
    private fun fetchRandomAlbums() {
        apiService.getRandomMusic("classic", "music", "song", "50")?.enqueue(object : Callback<AlbumResponse>{
            override fun onResponse(
                ...
                if(response.isSuccessful) {
                    ...
                    val adapter = ClassicAdapter(albumResponse.results)
                    binding.rvClassicList.adapter = adapter
                }
